        ...
        document.getElementById('cat').innerHTML +=
            `<div class="col-auto col-sm-auto col-md-auto col-lg-auto col-xl-auto mb-2 me-2">
                    <div class="card" ${categoria.backgroundColor} onclick="modalCat(${i}, ${valor})">                 
                        ...
                        <div class="card-body">
                            <h5 class="card-title fi-family fw-bold fs-2 text-light">${categoria.nombreCategoria}</h5>
                            <p class="card-text fbi-family fs-2  text-light">${categoria.empresas.length} comercios</p>
                        </div>
                    </div>             
            </div>`;
    })
